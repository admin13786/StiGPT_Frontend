...
import DocumentsPage from './pages/Knowledge/Documents';
import RagTestPage from './pages/Knowledge/RagTest';
import StatsPage from './pages/Knowledge/Stats';
          ...
          >
            <Routes>
              ...
              >
                ...
                <Route path="knowledge/:kbId/rag-test" element={<RagTestPage />} />
                <Route path="knowledge/:kbId/stats" element={<StatsPage />} />
